...
class student:
    def __init__(self,root):
        ...
        #update button
        update_btn=Button(btn_frame,text="UPDATE",font=("time new raman",12,"bold"),bg="black",fg="orange",width=16)
        update_btn.grid(row=0,column=1,)

        #delete button
        delete_btn=Button(btn_frame,text="DELETE",font=("time new raman",12,"bold"),bg="black",fg="orange",width=16)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                mycursor.execute("inster into student values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                                                                                                                self.var_dep.get(),
                                                                                                                self.var_course.get(),
                                                                                                                self.var_year.get(),

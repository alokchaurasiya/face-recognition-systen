    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbours,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence>77:
                    cv2.putText(img,f"ID:{i}",(x,y-70),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),1)
                    cv2.putText(img,f"Roll:{r}",(x,y-45),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),1)
                    cv2.putText(img,f"Name:{n}",(x,y-15),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),1)
                else:
                    cv2.rectangle(img,(x,y),(x+w,y+h),(0,0,255),3)
                    cv2.putText(img,"Unknown Face",(x,y-15),cv2.FONT_HERSHEY_COMPLEX,0.8,(220,20,60),1)
